        ...
        <div className="flex gap-6 px-4" style={{ minWidth: "min-content" }}>
          {items.map((item, index) => (
            <Link key={index} to={item.link} className="flex-shrink-0 w-80 group">
              <Card className="h-full transition-all duration-300 hover:shadow-xl hover:scale-105 border-primary/20 hover:border-primary bg-gradient-to-br from-card to-card/80">
                <CardHeader>
